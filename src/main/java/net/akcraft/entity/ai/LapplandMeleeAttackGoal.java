...
public class LapplandMeleeAttackGoal extends MeleeAttackGoal {
    ...
    public LapplandMeleeAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((LapplandEntity) mob);
    }
    ...
    protected boolean isTimeToAttack() {
        return this.ticksUntilNextAttack <= 9;
    }
